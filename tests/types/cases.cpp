...
TEST_CASE("Complex fn comparison", "[types]") {
  ...
  types::Type* fst = new types::FnType{{a, a, b, a}, new types::FnType{{a, b}}};
  types::Type* snd = new types::FnType{{a, a, b, a}, new types::FnType{{a, b}}};

  types::Type* not_fst_alpha =
      new types::FnType{{a, a, b, a}, new types::FnType{{b}}};
  types::Type* not_fst_beta =
      new types::FnType{{a, b, b, a}, new types::FnType{{b}}};
